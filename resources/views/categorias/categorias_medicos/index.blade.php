                ...
                @foreach($categorias as $categoria)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('categorias-medicos.edit', $categoria->id) }}" class="btn btn-warning btn-sm">Editar</a>
                            <form action="{{ route('categorias-medicos.destroy', $categoria->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
